...
<div class="container">
    <div class="row justify-content-center">
        <form action="index.php?act=updatemovie" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="d-flex">
                <div class="col-auto p-0">
                    ...
                    <input type="number" min="0" class="form-control w-50" name="epi" >
                </div>
            </div>
            <div class="d-flex justify-content-center py-3">
                <input type="hidden" name="idfilm" value="<?=$kqone[0]['IDFilm']?>">
